...
def train_single_scale(netD,netG,reals,Gs,Zs,in_s,NoiseAmp, errD_plot,errG_plot,rec_loss_plot,cyc_loss_plot, netD2,netG2,reals2,Gs2,Zs2,in_s2,NoiseAmp2, errD2_plot,errG2_plot,rec_loss2_plot,cyc_loss2_plot, opt,scale_num,centers=None):
    real = reals[len(Gs)]
    ...
    for epoch in range(opt.niter):
        ...
        errD_plot.append(errD_real.item()+errD_fake.item()+gradient_penalty.item())
        errD2_plot.append(errD_real2.item()+errD_fake2.item()+gradient_penalty2.item())
        ...
        errG_plot.append(errG.item())
        errG2_plot.append(errG2.item())
        rec_loss_plot.append(rec_loss.item())
        rec_loss2_plot.append(rec_loss2.item())
        cyc_loss_plot.append(cyc_loss.item())
        cyc_loss2_plot.append(cyc_loss2.item())
